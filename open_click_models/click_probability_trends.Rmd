...
<!-- Make sure the directory below and for loading m1_clicks.RData further down is correct. -->
...
```{r}
load("open_click_models/m1_clicks.RData")
```
...
```{r}
plot_smooth(m1, view = "days_since_start", cond = list(covid = "Before"),
...
```{r}
plot_smooth(m1, view = "days_since_start", cond = list(covid = "After"),
...
```{r}
plot_smooth(m1, view = "mins_since_midnight", cond = list(covid = "Before"),
            transform = expit,
            ylab = "Probability", xlab = "Date")
```

```{r}
plot_smooth(m1, view = "mins_since_midnight", cond = list(covid = "After"),
            transform = expit,
            ylab = "Probability", xlab = "Date")
```

```{r}
plot_smooth(m1, view = "num_words",
            transform = expit,
            ylab = "Probability")
```

```{r}
plot_smooth(m1, view = "num_links",
            transform = expit,
            ylab = "Probability")
```

```{r}
plot_smooth(m1, view = "num_clickable_pics",
            transform = expit,
            ylab = "Probability")
```

```{r}
plot_smooth(m1, view = "num_unclickable_pics",
            transform = expit,
            ylab = "Probability")

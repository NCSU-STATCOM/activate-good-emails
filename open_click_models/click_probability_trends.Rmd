...
Below are 10 sample observations from the dataset, containing the four "content" variables mentioned above. The last variable, clicks, is the response variable of interest. 1 indicates that the subscriber clicked on any link in a given newsletter; 0 indicates that the subscriber didn't click on any link in a given newsletter.
...
plot_smooth(m3, view = "num_words", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Click Probability vs. Word Count, given other covariates", xlab = "Word Count", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
...
plot_smooth(m3, view = "num_links", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Click Probability vs. Link Count, given other covariates", xlab = "Link Count", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
...
```{r}
plot(m3, select = 8, main = "Effect of Number of Clickable Pictures on Click Probability", xlab = "Number of Clickable Pictures", ylab = "Relative Effect", ylim = c(-1, 1))
...
plot_smooth(m3, view = "num_clickable_pics", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Click Probability vs. Number of Clickable Pictures", xlab = "Number of Clickable Pictures", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
...
```{r}
plot(m3, select = 9, main = "Effect of Number of Unclickable Pictures on Click Probability", xlab = "Number of Unclickable Pictures", ylab = "Relative Effect", ylim = c(-1, 1))
...
plot_smooth(m3, view = "num_unclickable_pics", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Click Probability vs. Number of Unclickable Pictures", xlab = "Number of Unclickable Pictures", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)

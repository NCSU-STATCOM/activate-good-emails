...
* Because the click probability is already quite low, changing the factors would not affect the click probability as much as it would affect the open probability. Thus, we recommend trying to increase the open rate before trying to change the click rate. 
...
```{r}
plot(m3, select = 3, main = "Effect of Hour of Day on Click Probability, Before COVID", xlab = "Hour of Day", ylab = "Relative Effect", xaxt = "n", ylim = c(-1.5, 1.7), xlim = c(6.8, 16.5) * 60)
...
plot_smooth(m3, view = "mins_since_midnight", cond = list(days_since_start = 334, 
            ...
            main = "Click Probability vs. Hour of Day, given other covariates", xlab = "Hour of Day", ylab = "Probability", xaxt = "n", 
            print.summary = FALSE, 
            ylim = ylim_span + 0, 
            xlim = c(6.8, 16.5) * 60)
...
```{r}
plot(m3, select = 4, main = "Effect of Hour of Day on Click Probability, During COVID", xlab = "Hour of Day", ylab = "Relative Effect", xaxt = "n", ylim = c(-1, 1))
...
The following plot shows the relative effect of the subject length on the click probability. The maximum click probability corresponds to a subject length of approximately 
...
plot_smooth(m3, view = "subject_length", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Click Probability vs. Subject Length, given other covariates", xlab = "Subject Length", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
...
plot_smooth(m3, view = "days_since_start", cond = list(covid = "Before"),
            ...
            main = "Click Probability over Time Before COVID",
            ylab = "Probability", xlab = "Date")
```
...
plot_smooth(m3, view = "days_since_start", cond = list(covid = "After"),
            ...
            main = "Click Probability over Time After COVID",
            ylab = "Probability", xlab = "Date")
```

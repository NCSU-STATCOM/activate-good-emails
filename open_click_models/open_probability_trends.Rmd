...
# Trends in the Open Probability: Executive Summary
...
# Trends in the Open Probability: Report
...
```{r}
plot(m4, select = 3, main = "Hour of Day, Before COVID", xlab = "Hour of Day", ylab = "Relative Effect", xaxt = "n", ylim = c(-1.5, 1.5), xlim = c(6.8, 16.5) * 60)
...
plot_smooth(m4, view = "mins_since_midnight", cond = list(days_since_start = 334, 
            ...
            main = "Open Probability vs. Hour of Day, Before COVID", xlab = "Hour of Day", ylab = "Probability", xaxt = "n", 
            print.summary = FALSE, 
            ylim = ylim_span + 0, 
            xlim = c(6.8, 16.5) * 60)
...
```{r}
plot(m4, select = 4, main = "Hour of Day, During COVID", xlab = "Hour of Day", ylab = "Relative Effect", xaxt = "n", ylim = c(-1, 1))
...
plot_smooth(m4, view = "mins_since_midnight", cond = list(days_since_start = 700, 
                                                          subject_length = 66),
            transform = expit, hide.label = TRUE, 
            main = "Open Probability vs. Hour of Day, During COVID", xlab = "Hour of Day", ylab = "Probability", xaxt = "n", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
...
plot_smooth(m4, view = "subject_length", cond = list(days_since_start = 700, 
                                                          mins_since_midnight = 630),
            transform = expit, hide.label = TRUE, 
            main = "Open Probability vs. Subject Length", xlab = "Subject Length", ylab = "Probability", 
            print.summary = FALSE, 
            ylim = ylim_span + 0)
```
